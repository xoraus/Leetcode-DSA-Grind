...
class Solution
{
   ...
   public int getCount(Node root, int low, int high) {
        ...
        // If the current node's value is within the range [low, high], increment the count
    ...
    // Example usage:
    // TreeNode root = ...; // Initialize your BST
    // int low = 5, high = 45; // Set your range
    // int count = countNodesInRange(root, low, high);
    // System.out.println("Number of nodes in the range: " + count);
